 ...
 * @returns {Object} return.data - 매핑된 폴더 데이터 객체입니다.
 * @returns {string} return.data.profileImage - 폴더 소유자의 프로필 이미지 URL입니다.
 * @returns {string} return.data.ownerName - 폴더 소유자의 이름입니다.
 * @returns {string} return.data.folderName - 폴더의 이름입니다.
 * @returns {Array} return.data.links - 폴더에 포함된 링크의 배열입니다.
 *
 * @example
