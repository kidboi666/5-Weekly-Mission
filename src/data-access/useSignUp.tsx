 ...
 *
 * @param {UseSignUpParams} params - 사용자 등록에 필요한 이메일과 비밀번호입니다.
 * @param {string} params.email - 사용자 이메일 주소입니다.
 * @param {string} params.password - 사용자 비밀번호입니다.
 * @returns {Object} 훅의 반환 객체입니다.
 * @returns {() => Promise<void>} return.execute - 사용자 등록을 수동으로 실행하는 함수입니다.
 * @returns {boolean} return.loading - 사용자 등록 요청의 로딩 상태입니다.
 * @returns {any | null} return.error - 사용자 등록 요청 중 발생한 오류입니다.
 * @returns {Token | null} return.data - 사용자 등록 응답 데이터입니다.
 *
 * @example
