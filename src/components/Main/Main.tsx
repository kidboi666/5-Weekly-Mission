  ...
  return (
    <main>
      <section className={styles.section01}>
        <h2>
          <span className={styles.textGradient}>세상의 모든 정보를</span>
          <br className="br" />
          쉽게 저장하고 관리해 보세요
        </h2>
          ...
          <ul>
            <li className="flexBox">
              <div className={styles.textBox}>
                <h3>
                  <span className={styles.textGradient}>원하는 링크</span>를<br className="br" />
                  저장하세요
                </h3>
                <p>
            ...
            <li className="flexBox">
              ...
              <div className={styles.textBox}>
                <h3>
                  링크를 폴더로
                  <br className="br" />
                  <span className={styles.textGradient}>관리</span>하세요
                </h3>
                <p>
                  나만의 폴더를 무제한으로 만들고
                  <br className="br" />
            ...
            <li className="flexBox">
              <div className={styles.textBox}>
                <h3>
                  저장한 링크를
                  <br className="br" />
                  <span className={styles.textGradient}>공유</span>해 보세요.
                </h3>
                <p>
            ...
            <li className="flexBox">
              ...
              <div className={styles.textBox}>
                <h3>
                  저장한 링크를
                  <br className="br" />
                  <span className={styles.textGradient}>검색</span>해 보세요
                </h3>
